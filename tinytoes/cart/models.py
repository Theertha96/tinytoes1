...
from adminapp.admin import *

# Create your models here.

from accounts.models import * 
from tinytoes import settings
...
class Cartitem(models.Model):
    ...
    varient=models.ForeignKey(ProductSize,on_delete=models.CASCADE,null=True)
...
class OrderProduct(models.Model):
    ...
    variation = models.ForeignKey(ProductSize,on_delete=models.CASCADE,null=True)
